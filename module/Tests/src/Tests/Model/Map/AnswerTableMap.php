...
use Tests\Model\Answer;
use Tests\Model\AnswerQuery;
...
class AnswerTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Tests.src.Tests.Model.Map.AnswerTableMap';
     ...
     */
    const OM_CLASS = '\\Tests\\Model\\Answer';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Tests.src.Tests.Model.Answer';
     ...
     */
    const COL_LABEL = 'answer.label';

    /**
     * the column name for the id_question field
     */
    const COL_ID_QUESTION = 'answer.id_question';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Tests\\Model\\Answer');
        $this->setPackage('Tests.src.Tests.Model');
        $this->setUseIdGenerator(true);
        // columns
        $this->addColumn('label', 'Label', 'LONGVARCHAR', true, null, null);
        $this->addForeignKey('id_question', 'IdQuestion', 'INTEGER', 'question', 'id', true, null, null);
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(AnswerTableMap::COL_LABEL);
            $criteria->addSelectColumn(AnswerTableMap::COL_ID_QUESTION);
            $criteria->addSelectColumn(AnswerTableMap::COL_ID);
        } else {
            $criteria->addSelectColumn($alias . '.label');
            $criteria->addSelectColumn($alias . '.id_question');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Tests\Model\Answer) { // it's a model object

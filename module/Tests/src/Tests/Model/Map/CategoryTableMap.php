...
class CategoryTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Tests.src.Tests.Model.Map.CategoryTableMap';
     ...
     */
    const OM_CLASS = '\\Tests\\Model\\Category';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Tests.src.Tests.Model.Category';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Tests\\Model\\Category');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Tests\Model\Category) { // it's a model object

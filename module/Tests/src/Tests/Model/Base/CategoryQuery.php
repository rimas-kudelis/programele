...
use Tests\Model\Map\CategoryTableMap;
 ...
 *
 * @method     ChildCategoryQuery leftJoinQuestion($relationAlias = null) Adds a LEFT JOIN clause to the query using the Question relation
 * @method     ChildCategoryQuery rightJoinQuestion($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Question relation
 * @method     ChildCategoryQuery innerJoinQuestion($relationAlias = null) Adds a INNER JOIN clause to the query using the Question relation
 *
...
abstract class CategoryQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Tests\Model\Base\CategoryQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'tests', $modelName = '\\Tests\\Model\\Category', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT title, id FROM category WHERE id = :p0';
        try {
     ...
     *
     * @param \Tests\Model\Question|ObjectCollection $question  the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
    ...
    public function filterByQuestion($question, $comparison = null)
    {
        if ($question instanceof \Tests\Model\Question) {
            return $this
                ->addUsingAlias(CategoryTableMap::COL_ID, $question->getIdCategory(), $comparison);

...
abstract class Category implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Tests\\Model\\Map\\CategoryTableMap';
    ...
    /**
     * Initializes internal state of Tests\Model\Base\Category object.
     */
     ...
     * @return $this|\Tests\Model\Category The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : CategoryTableMap::translateFieldName('Title', TableMap::TYPE_PHPNAME, $indexType)];
            $this->title = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CategoryTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Tests\\Model\\Category'), 0, $e);
        }
    }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->questionsScheduledForDeletion !== null) {
                if (!$this->questionsScheduledForDeletion->isEmpty()) {
                    \Tests\Model\QuestionQuery::create()
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Tests\Model\Category
     */
     ...
     *
     * @return $this|\Tests\Model\Category The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Tests\Model\Category (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Tests\Model\Category Clone of current object.
     * @throws PropelException
     */
    ...
    public function initQuestions($overrideExisting = true)
    {
        ...
        $this->collQuestions->setModel('\Tests\Model\Question');
    }
    ...
    public function setQuestions(Collection $questions, ConnectionInterface $con = null)
    {
        ...
        foreach ($questionsToDelete as $questionRemoved) {
            $questionRemoved->setCategory(null);
        }
